...
import { Image, View, ScrollView, Text, StyleSheet, Dimensions, Linking,TouchableOpacityBase } from 'react-native';
...
export default function OrphanageDetails() {
  ...
  function handleToRouteGoogleMaps(){
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        ...
        <View style={styles.mapContainer}>
          ...
          <TouchableOpacity 
            onPress={handleToRouteGoogleMaps}
